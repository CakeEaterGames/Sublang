...
namespace Sublang
{
    ...
    public sealed class TokenDefinition
    {
        ...
        public TokenDefinition(string regex, TokenType token)
        {
    ...
    public sealed class Lexer : IDisposable
    {
        ...
        public List<Token> GetAllTokens()
        {
            ...
            while (Next())
                if (CurToken != TokenType.comment && CurToken != TokenType.space)
                    res.Add(new Token(TokenContents, CurToken,Position, LineNumber));
